...
#test
cho = ConCho("Micky", "nâu", "corgi")
cho.sua(); cho.an("hạt")

xe = Oto("Kya", "seltos", "trắng", 800_000_000)
xe.tang_toc(60); xe.tang_toc(40); xe.giam_toc(30)

tk = TaiKhoan("Thu Trang xinh gai", "686868868", "BIDV", 10_000_000)
tk.gui(4_000_000); tk.rut(6_000_000); tk.kiem_tra_so_du()